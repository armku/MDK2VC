...
namespace MDK2VC.M2V.Xml
{
    public class ToVC2017 : IToVC2017
    {
        ...
        public void createfilters(SysConfig cfg)
        {
            ...
            builder.AppendLine("      <UniqueIdentifier>{84dde6bb-c6fa-46e9-ab10-5f5c58d49657}</UniqueIdentifier>");
            builder.AppendLine("      <Extensions>cpp;c;cc;cxx;def;odl;idl;hpj;bat;asm;asmx</Extensions>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"头文件\">");
            builder.AppendLine("      <UniqueIdentifier>{ce927e82-719d-458e-ba74-766d750451b1}</UniqueIdentifier>");
            builder.AppendLine("      <Extensions>h;hpp;hxx;hm;inl;inc;xsd</Extensions>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"项目说明\">");
            builder.AppendLine("      <UniqueIdentifier>{3c97dfbf-e3d1-4f2c-b4b6-2ccca350f793}</UniqueIdentifier>");
            builder.AppendLine("      <Extensions>txt</Extensions>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\Application\">");
            builder.AppendLine("      <UniqueIdentifier>{ddff51dc-ecbd-4c2a-908d-33be0d73e051}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\Driver\">");
            builder.AppendLine("      <UniqueIdentifier>{025b7039-8ee1-4c35-9f6a-937be9e85661}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\ST_Library\">");
            builder.AppendLine("      <UniqueIdentifier>{ac58a73b-dbaa-444c-91ac-1dac570d255b}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\Cortex_M3\">");
            builder.AppendLine("      <UniqueIdentifier>{cb276479-7ff4-4ea6-857c-01fa10c3906b}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\RT_Thread\">");
            builder.AppendLine("      <UniqueIdentifier>{bc04bcf0-1511-4828-9140-860f4f237eb1}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("    <Filter Include=\"源文件\\RT_Component\">");
            builder.AppendLine("      <UniqueIdentifier>{3ed02d7e-d02b-47b4-9a49-d2c16296718f}</UniqueIdentifier>");
            builder.AppendLine("    </Filter>");
            builder.AppendLine("  </ItemGroup>");
            builder.AppendLine("  <ItemGroup>");
            builder.AppendLine("    <ClCompile Include=\"..\\Application\\application.c\">");
            builder.AppendLine("      <Filter>源文件\\Application</Filter>");
            builder.AppendLine("    </ClCompile>");
            ...
            builder.AppendLine("      <Filter>源文件\\Application</Filter>");
            builder.AppendLine("    </None>");
            builder.AppendLine("    <None Include=\"..\\ST_Library\\CMSIS\\CM3\\DeviceSupport\\ST\\STM32F10x\\startup\\arm\\startup_stm32f10x_hd.s\">");
            builder.AppendLine("      <Filter>源文件\\ST_Library</Filter>");
            builder.AppendLine("    </None>");
            builder.AppendLine("    <None Include=\"..\\RT_Thread\\libcpu\\arm\\cortex - m3\\context_rvds.S\">");
            builder.AppendLine("      <Filter>源文件\\Cortex_M3</Filter>");
            builder.AppendLine("    </None>");
            builder.AppendLine("    <None Include=\"Readme.txt\">");
            builder.AppendLine("      <Filter>项目说明</Filter>");
            builder.AppendLine("    </None>");
            builder.AppendLine("  </ItemGroup>");
            builder.AppendLine("</Project>");
#endif
